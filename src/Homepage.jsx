  ...
  return (
      <div
        ...
        <header
          ...
          <nav
            ...
            <div className="flex items-center space-x-2">
              ...
              <span
                  className="text-2xl font-bold text-blue-700">Breathe Easy</span>
            </div>
            ...
            {/* Mobile Menu Icon */}
            <button
                className="md:hidden flex items-center text-blue-600 text-2xl">
        ...
        >
          ...
          />
          <div
              className="absolute inset-0 bg-gradient-to-b from-black/60 to-black/20"></div>
          <div className="relative z-10 max-w-2xl px-6">
            <h1 className="text-5xl md:text-6xl font-serif mb-6">Breathe Easy,
              Live Better</h1>
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center">
              ...
              <button
                  className="px-8 py-3 rounded-full border-2 border-blue-600 text-blue-600 hover:bg-blue-50 font-sans">
                Learn More
              </button>
            </div>
          </div>
        ...
        <section className="py-20 bg-white/50">
          <div className="container mx-auto px-6 text-center">
            <h2 className="text-4xl text-blue-800 mb-16">Find Balance in Your
              Daily Life</h2>
        ...
        <section
          ...
          <div className="container mx-auto px-6 text-center">
            <h2 className="text-4xl text-blue-800 mb-6">Start Your Journey to
              Inner Peace</h2>
        ...
        <footer className="bg-white/80 backdrop-blur-sm py-12">
          <div className="container mx-auto px-6 text-center">
            <p className="text-blue-600">&copy; 2025 Breathe Easy. All rights
              reserved.</p>
          </div>
        </footer>
      </div>
...
const Feature = ({icon, title, description}) => (
    <div
        className="text-center p-8 rounded-xl bg-white/80 backdrop-blur-sm hover:shadow-lg transition-all">
